        ...
        <div class="body_container">
            ...
            <div class="info_container" id="info-container">
                ...
                <div class="info_block">
                    <!-- Заголовок блока -->
                    <div class="info_block_title">о команде проекта</div>

                    <!-- Основной текст блока -->
                    <div class="info_block_text">
                        Наша команда состоит из студентов IT-университета, поэтму мы, как никто, понимаем сложность и
                ...
                <div class="info_block">
                    ...
                    <!-- Основной текст блока -->
                    <div class="info_block_text">
                        Наш сервис призван сделать процесс выбора профессии максимально
                        простым и интерактивным. Начните свой путь в IT
                        здесь!
                    </div>
                </div>
                ...
                <div class="info_block">
                    ...
                    <!-- Основной текст блока -->
                    <div class="info_block_text">
                        Свяжитесь с нами по телефону +7 667 228-81-52 или по
                        электронной почте info@667gang.ru.
                    </div>
                </div>
            </div>
        </div>
