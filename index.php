        ...
        <div class="body_container">
            ...
            <div class="info_container" id="info-container">
                ...
                <div class="info_block">
                    <!-- Заголовок блока -->
                    <div class="info_block_title">Кто мы?</div>

                    <!-- Основной текст блока -->
                    <div class="info_block_text">
                        Мы компания, которая помогает студентам определиться
                        с направлением в IT.
                    </div>
                </div>
                ...
                <div class="info_block">
                    <!-- Заголовок блока -->
                    <div class="info_block_title">Зачем мы?</div>

                    <!-- Основной текст блока -->
                    <div class="info_block_text">
                        Мы делаем процесс выбора профессии максимально
