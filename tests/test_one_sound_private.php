<?php
session_start();
// Отключено подключение к базе данных
// include '../scripts/check_attemts/one_sound_attemts.php';
?>
<!DOCTYPE html>
<html lang="ru">
<head>
...
<body>
    <div class="container">
        <div class="header_container" id="header">
            <a href="#" onclick="location.href='index.php';" class="icon_button"></a>
        ...
        <div id="results">
            ...
            <p>Правильных кликов: <span id="accuracy">0</span></p>
            <p>Ошибок: <span id="misses">0</span></p>
        </div>
    ...
    <script src="../scripts/test_scripts/test_onesound.js" defer></script>
</body>
</html>
